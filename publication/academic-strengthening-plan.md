...
- `publication/swarm-governed-agents.tex` -- main paper (all structural changes)
- `publication/references.bib` -- add SECP citation + ~5 new references from their bibliography
