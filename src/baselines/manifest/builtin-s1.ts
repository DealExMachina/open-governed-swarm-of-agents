...
const S1_DOCUMENTS: ScenarioDocument[] = [
  {
    ...
    expectedClaims: [
      ...
      {
        dimension: "arr_growth",
        content: "45% CAGR (2021-2024)",
        confidence: 0.7,
        source: "doc-01",
      },
      {
      ...
      {
        dimension: "patents",
        content: "7 patents granted, 2 pending",
        confidence: 0.8,
        source: "doc-01",
      },
      {
        dimension: "clients",
        content: "47 enterprise clients",
        confidence: 0.8,
        source: "doc-01",
      },
      {
        dimension: "valuation",
        content: "Indicative valuation €420M (8.4x ARR)",
        confidence: 0.6,
        source: "doc-01",
      },
    ],
  ...
  },
  {
    ...
    expectedClaims: [
      ...
      },
      {
        ...
        content: "2 patents co-ownership dispute with Dr. Klaus Haber",
        confidence: 0.85,
        source: "doc-02",
      },
      {
    ...
    expectedClaims: [
      {
        ...
        content: "CTO + 2 senior engineers departing Q4/Q1",
        confidence: 0.9,
        source: "doc-03",
      },
      {
    ...
    contradictions: [
      {
        ...
        severity: "medium",
        description:
          "Critical key-person concentration risk not disclosed initially",
      },
    ],
  },
  {
    ...
    expectedClaims: [
      {
        ...
        content: "Axion Corp filed patent suit on EP3847291",
        confidence: 0.9,
        source: "doc-04",
      },
      {
        dimension: "customer_concentration",
        content: "Largest client (€8.2M ARR = 21.6%) evaluating alternatives",
        confidence: 0.85,
        source: "doc-04",
      },
    ],
    contradictions: [
      {
        ...
        newValue:
          "Same patent EP3847291 now contested from 2 directions (Haber + Axion)",
        severity: "high",
        description:
          "Compound patent risk — same IP disputed by two parties simultaneously",
      },
      {
        dimension: "customer_concentration",
        ...
        severity: "medium",
        description:
          "Revenue concentration risk — single client represents >20% ARR",
      },
    ],
  },
  {
    ...
    expectedClaims: [
      ...
      },
      {
        ...
        content: "Axion settlement €1.5-2M, Haber buyout €800K-1.2M",
        confidence: 0.8,
        source: "doc-05",
      },
    ],
...
const S1_AGENT_ROLES: AgentRole[] = [
  {
    ...
    responsibility:
      "Extract and validate financial claims (ARR, margins, valuation)",
...
Output structured claims with confidence scores.`,
  },
  {
    ...
    name: "Legal Counsel",
    responsibility:
      "Assess IP ownership, litigation risk, regulatory compliance",
...
Assess whether the target meets acquirer compliance standards.`,
  },
  {
    ...
    name: "Risk Analyst",
    responsibility:
      "Evaluate key-person risk, customer concentration, operational risk",
...
Assess risk severity and recommend mitigation strategies.`,
  },
  {
    ...
    responsibility:
      "Analyze competitive landscape, market position, customer dynamics",
...
export function buildS1ProjectHorizonPackage(
  repoRoot: string,
