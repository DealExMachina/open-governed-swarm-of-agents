 ...
 *
 * Usage:
 *   pnpm tsx scripts/experiments/analyze-experiment.ts <batch_dir>
 *   pnpm tsx scripts/experiments/analyze-experiment.ts docs/experiments/exp1/results/2026-02-28T...-batch-n3
 *
...
function main(): void {
  ...
  if (!batchDir || !existsSync(batchDir)) {
    console.error("Usage: pnpm tsx scripts/experiments/analyze-experiment.ts <batch_dir>");
    process.exit(1);
  }
