 ...
 *
 * Usage:
 *   pnpm tsx scripts/experiments/analyze-scalar-vs-vector.ts <ab-results-dir>
 *
...
function main(): void {
  ...
  if (!abDir) {
    console.error("Usage: pnpm tsx scripts/experiments/analyze-scalar-vs-vector.ts <ab-results-dir>");
    process.exit(1);
  }
