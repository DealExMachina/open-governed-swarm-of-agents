 ...
 *
 * Usage:
 *   LOAD_INJECT_DELAY_MS=2000 pnpm tsx scripts/experiments/loadgen-inject.ts
 *   LOAD_BURST=1 pnpm tsx scripts/experiments/loadgen-inject.ts
 *   LOAD_REPEAT=3 pnpm tsx scripts/experiments/loadgen-inject.ts
 *
