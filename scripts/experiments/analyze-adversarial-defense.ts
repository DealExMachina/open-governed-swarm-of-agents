 ...
 *
 * Usage:
 *   pnpm tsx scripts/experiments/analyze-adversarial-defense.ts docs/experiments/exp8/results/
 */
...
function main(): void {
  ...
  if (!existsSync(resultsDir)) {
    ...
    console.error("Run experiment first: bash scripts/experiments/run-experiment.sh exp8");
    process.exit(1);
  }
