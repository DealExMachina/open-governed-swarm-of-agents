 ...
 *
 * Usage:
 *   pnpm tsx scripts/experiments/drive-exp8-adversarial.ts --mode=baseline --rounds=7 --interval=20
 *   pnpm tsx scripts/experiments/drive-exp8-adversarial.ts --mode=inflate  --rounds=7
 *   pnpm tsx scripts/experiments/drive-exp8-adversarial.ts --mode=collude  --rounds=7
 *
