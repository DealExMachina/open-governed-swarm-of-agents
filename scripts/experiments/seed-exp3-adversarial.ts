 ...
 *
 * Usage:
 *   pnpm tsx scripts/experiments/seed-exp3-adversarial.ts --pattern=spike-and-drop
 *   pnpm tsx scripts/experiments/seed-exp3-adversarial.ts --pattern=oscillating
 *   pnpm tsx scripts/experiments/seed-exp3-adversarial.ts --pattern=stale
 *   pnpm tsx scripts/experiments/seed-exp3-adversarial.ts --pattern=empty
 *
...
function parseArgs(): Exp3Pattern {
  ...
  if (!arg) {
    console.error("Usage: pnpm tsx scripts/experiments/seed-exp3-adversarial.ts --pattern=<spike-and-drop|oscillating|stale|empty>");
    process.exit(1);
  }
