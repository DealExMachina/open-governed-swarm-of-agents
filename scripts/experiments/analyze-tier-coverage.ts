 ...
 *
 * Usage:
 *   pnpm tsx scripts/experiments/analyze-tier-coverage.ts <results-dir-or-file>
 *   pnpm tsx scripts/experiments/analyze-tier-coverage.ts docs/experiments/exp7/results/2026-03-04T12-00-00
 */
