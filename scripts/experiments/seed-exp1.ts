 ...
 *
 * Usage:
 *   pnpm tsx scripts/experiments/seed-exp1.ts [--contradictions=0|1|3|5]
 *   SCOPE_ID=my-scope pnpm tsx scripts/experiments/seed-exp1.ts --contradictions=3
 *
...
function parseArgs(): number {
  ...
  if (!arg) {
    console.error("Usage: pnpm tsx scripts/experiments/seed-exp1.ts --contradictions=<0|1|3|5>");
    process.exit(1);
  }
