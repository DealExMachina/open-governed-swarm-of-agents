 ...
 *
 * Usage:
 *   pnpm tsx scripts/benchmarks/benchmark-langchain-agents.ts
 *   pnpm tsx scripts/benchmarks/benchmark-langchain-agents.ts --scale=medium --runs=3
 *   pnpm tsx scripts/benchmarks/benchmark-langchain-agents.ts --agents=10 --queries=50
 *
 * Options:
