 ...
 *
 * Usage:
 *   pnpm tsx scripts/benchmarks/benchmark-multi-scope.ts
 *   pnpm tsx scripts/benchmarks/benchmark-multi-scope.ts --scale=medium --runs=3
 *   pnpm tsx scripts/benchmarks/benchmark-multi-scope.ts --scopes=500 --instances=4
 *
 * Options:
