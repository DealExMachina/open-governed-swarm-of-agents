 ...
 *
 * Usage:
 *   pnpm tsx scripts/benchmarks/benchmark-sgrs-load.ts
 *   pnpm tsx scripts/benchmarks/benchmark-sgrs-load.ts --instances=8 --duration=10 --mix=both
 *   pnpm tsx scripts/benchmarks/benchmark-sgrs-load.ts --instances=4 --ops=50000
 *   pnpm tsx scripts/benchmarks/benchmark-sgrs-load.ts --scale=medium --runs=3
 *   pnpm tsx scripts/benchmarks/benchmark-sgrs-load.ts --scopes=10 --instances-per-scope=4
 *
 * Options:
