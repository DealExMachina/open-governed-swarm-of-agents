 ...
 *
 * Usage:
 *   pnpm tsx scripts/benchmarks/benchmark-mastra-agents.ts
 *   pnpm tsx scripts/benchmarks/benchmark-mastra-agents.ts --scale=medium --runs=3
 *   pnpm tsx scripts/benchmarks/benchmark-mastra-agents.ts --agents=10 --tasks=100
 *
 * Options:
