 ...
 *
 * Usage:
 *   pnpm tsx scripts/benchmarks/benchmark-agentica-agents.ts --scale=tiny
 *   pnpm tsx scripts/benchmarks/benchmark-agentica-agents.ts --scale=medium --runs=3
 *   pnpm tsx scripts/benchmarks/benchmark-agentica-agents.ts --connected --model=qwen3:4b
 *
 * Options:
