 ...
 *
 * Usage:
 *   pnpm tsx scripts/benchmarks/benchmark-gateway-load.ts
 *   pnpm tsx scripts/benchmarks/benchmark-gateway-load.ts --scale=medium --runs=3
 *   pnpm tsx scripts/benchmarks/benchmark-gateway-load.ts --clients=200 --duration=30
 *
 * Options:
