 ...
 *
 * Usage:
 *   pnpm tsx scripts/benchmarks/benchmark-comparative.ts --preset=smoke
 *   pnpm tsx scripts/benchmarks/benchmark-comparative.ts --preset=smoke-llm
 *   pnpm tsx scripts/benchmarks/benchmark-comparative.ts --preset=smoke --llm
 *   pnpm tsx scripts/benchmarks/benchmark-comparative.ts --preset=small --seeds=30
 *   pnpm tsx scripts/benchmarks/benchmark-comparative.ts --preset=medium --model=qwen3:4b
 *
 * Options:
