 ...
 *
 * Usage:
 *   npx tsx scripts/report-pipeline-metrics.ts
 *   npx tsx scripts/report-pipeline-metrics.ts --held-out
 *   FACTS_WORKER_URL=http://127.0.0.1:8011 npx tsx scripts/report-pipeline-metrics.ts --live
 */
