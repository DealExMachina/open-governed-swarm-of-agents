 ...
 *
 * Usage:
 *   pnpm tsx scripts/ops/simulate-mitl-approve.ts [--interval-ms=5000] [--once]
 *   pnpm tsx scripts/ops/simulate-mitl-approve.ts --finality-option=approve_finality
 *   MITL_INTERVAL_MS=3000 pnpm tsx scripts/ops/simulate-mitl-approve.ts
 *
